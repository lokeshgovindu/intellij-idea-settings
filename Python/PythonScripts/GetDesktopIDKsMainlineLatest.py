...
__MFT__             = 'DesktopIDKs'
__MLABEL__          = 'DesktopIDKs_Mainline'
...
def main():
    ...
    uncPath = os.path.dirname(itemsList[0])
    ...
    # ------------------------------------------------------------------------------
    # Get file/directory using NcFTPGet
    # ------------------------------------------------------------------------------
    while True:
        exitCode = CommonUtils.GetDirectory(opts.username, opts.password, ftpPath, localTargetDirectory)
