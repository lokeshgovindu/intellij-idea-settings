...
If file path is '\\atltruck\Products\IDKs\Mainline\DesktopIDKs\DesktopIDKs_2014-11-22_0346_b2638' and here

  productname : [DesktopIDKs]
      version : [Mainline]
        build : [DesktopIDKs_2014-11-22_0346_b2638]

then you need to use '\\atltruck\Products\IDKs\{version}\{productname}\{build}'. Parse module can parse
the string using specified format pattern.
...
"""
    ...
    productname, version, build = CommonUtils.GetProductNameVersionBuild(uncPath, uncPathFormat)
