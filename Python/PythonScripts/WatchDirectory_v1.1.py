...
class LoGoFileSystemWatcher:
    def __init__(self,
        ...
        """
        :param directoryPath: Directory path to be watched
...
def main_normal():
    ...
    parser = argparse.ArgumentParser(fromfile_prefix_chars='@',
                                     ...
                                     \nwill be treated as files, and will be replaced\
                                     \nby the arguments they contain.")
    parser.add_argument('--directory', '--directory-path', dest='directory', type=ValidDirectoryPath,
                        required=True, help='Directory path to be watched.')
    parser.add_argument('--file-pattern', type=str,
                        action='store', metavar='FILEPATTERN', dest='filePattern', required=True,
                        help='File pattern, you can use wildcard chars (required)')
    ...
    watcher = LoGoFileSystemWatcher(directoryPath=opts.directory,
